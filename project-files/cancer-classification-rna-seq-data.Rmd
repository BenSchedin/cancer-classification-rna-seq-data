...
Support Vector Machines (SVM) was applied to the data with 75% of samples used for training and the remaining 25% used for testing. In order to tune the hyperparameters for the model, `e1071::tune` was used with $cost = {0.01, 0.1, 1, 5, 10, 50}$
```{r svm, warning=FALSE}
