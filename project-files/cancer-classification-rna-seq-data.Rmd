...
# I. Abstract
The ability to classify cancer types based on gene expressions constitutes a valuable tool for both researchers and clinicians alike. In this analysis, various cancer classification methods are applied to genetic data to determine the performance of each method with various configurations.
